...
<table width="100%" style="height: 100%;" cellpadding="10" cellspacing="0" border="0">
  <tr>
	...
	K-Connect Accounting System and CMS</div></td>
  </tr>
  <tr>
    <!-- ============ LEFT COLUMN (MENU) ============== -->
    <td width="2%" valign="top" class="title_column"><br></td>
...
<IMG SRC="Urgentevents.bmp"
   ...
   USEMAP="#map1"><BR>
			...
			<li class=""><a href="import4HTMLtoExcel.php">StreetLights</a></li>
			<li class=""><a href="truncate.php">Truncate</a></li>
   ...
   <MAP NAME="map2">
<AREA
   HREF="select_cust.php" ALT="Select Customer" TITLE="Select Customer"
   SHAPE=RECT COORDS="43,9,97,26">
<AREA
   HREF="unselect_cust.php" ALT="Unselect Customer" TITLE="Unselect Customer"
...
<li class=""><a href="select_invPDF.php">Invoice To PDF</a></li><br />
<li class=""><a href="prod_by_cust.php">Product By Cust</a></li><br />


   
        <MAP NAME="map5">
<AREA
   HREF="add_eventCsess.php" ALT="Add new event" TITLE="Add new event"
...
<IMG SRC="events.bmp" align = "center"
  ...
  <br> <br>
      ...
      <MAP NAME="map4">
<AREA
   HREF="add_trans2sess.php" ALT="Add new transaction" TITLE="Add new transaction"
   SHAPE=RECT COORDS="49,4,95,22">
<AREA
   HREF="add_trans.php" ALT="Add transaction" TITLE="Add transaction"
   SHAPE=RECT COORDS="49,24,89,38">
<AREA
   ...
   USEMAP="#map4"><!--<BR>-->
      ...
      <br> 
   	...
   	<!--		<li class=""><a href="./view_event_all_HP.php">Edit All HighPriority events</a></li>-->
		...
		<!--	<li class=""><a href="./company.php">KConnect details</a></li>-->
...
<!--			<li class=""><a href="./urgent_events.php">Urgentevents</a></li>
			<li class=""><a href="./select_cust.php">SELECT Customer</a></li>
			<li class=""><a href="./unselect_cust.php">UNSELECT Customer</a></li>
...
<!--			<li class=""><a href="./add_eventCsess.php">Add eventC</a></li>
			...
			<li class=""><a href="./outstanding.php">Outstanding payments</a></li><br />
			<li class=""><a href="../phpMyAdmin-3.5.2-english/index.php?db=kc&token=954ececb41886fa8043ceefca56c867d#PMAURL:db=kc&server=1&target=db_export.php" target = "_blank">BACKUP complete database</a></li>
			
			
			<li class=""><a href="./interrogate.php">interrogate the line</a></li><br />
			<li class=""><a href="http://localhost/php-calendar-2.0-rc6/">PHP Calendar</a></li><br />
			<li class=""><a href="./codetricks.php">Code Tricks</a></li><br />
			
			
			<li class=""><a href="./add_JC.php">Add JobCardC</a></li>
			<li class=""><a href="./edit_JC.php">Edit JobCard</a></li>
			...
			<li class=""><a href="../phpMyAdmin-3.5.2-english/index.php?db=kc&token=218d93aa9bb914967a647a013f3ad1e8#PMAURL:db=kc&server=1&target=db_structure.php&token=218d93aa9bb914967a647a013f3ad1e8" target="_blank">phpMyAdmin</a></li><br>
			
			
			<li class=""><a href="./1.php" target = "_blank">SQL check</a></li>
			<!--<li class=""><a href="./tables.php" target = "_blank">Show all tables</a></li>-->
			<li class=""><a href="./SQlCreateTables_TRANSACTIONAL DATABASE.txt" target = "_blank">SQL database code</a></li>
...
<!--			<li class=""><a href="./cnt.php">Count Tables</a></li>
			...
			<li class=""><a href="./links.php">Fav links</a></li>
			<li class=""><a href="./javatest.php">Javascript test</a></li>
	
			<li class=""><a href="./1111home.php">Home</a></li>
			<li class=""><a href="just-ajax-table/">AJAX</a></li>
...
<!--<li class="current_page_item"><a href="#">Products</a></li>-->
		<li class="current_page_item"><a href="./view_prod.php">Products</a></li>-->
		<li class="current_page_item"><a href="./view_prod_all.php">Products</a></li>-->
	<li class=""><a href="./add_prod.php">Add Product</a></li>-->
...
<!--			<li class=""><a href="./edit_prod.php">Edit/Delete Product_line</a></li>
	...
	<li class=""><a href="http://localhost/wwwlatest/ggcFinal/cartBACKUP/GosselinGourmetCoffee.php">View Coffee Shop</a></li>-->
